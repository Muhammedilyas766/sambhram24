...
$(".button-solidM2").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">TECH HUMANOS</p><p>[MBA]</p><p id="date">Date: Day 1 & 2</p><p id="fee">Entry Fee: Rs 200/-</p><p id="location">Location:404(New Building) </p><p id="time">Timing: 11:00 AM -- 5:00 PM<br/>Day-2 : 9:00 AM-- 4:00 PM</p><p>Student Coordinator:<br> Ms. SHABNAM KHATUN (+91 7483105970)</p><p id="rules">Rules: <br />2 make a team. Any number of teams can participate in the event.The event is open to PG students. Participants should carry laptops, net setters, pen drives etc. for their use. The organisers shall not be responsible for providing any of these items.Judges’ and the organisers’ decision will be final and binding.Any team found using unfair means shall be immediately disqualified.To keep your identity confidential, participants are supposed to use the team name allotted by the Echelon team.     </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solidM3").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">TECH IGNITE </p><p>[MBA]</p><p id="date">Date: Day 1 & 2</p><p id="fee">Entry Fee: Rs 200/-</p><p id="location">Location: 104(New Building)</p><p id="time">Timing: 11:00 AM -- 5:00 PM <br/>Day-2 : 9:00 AM-- 4:00 PM</p><p>Student Coordinator:<br>Ms. AFRAZ FATHIMA (+91 8050101620)</p><p id="rules">Rules: <br />Two make a team. Any number of teams can participate in the event. The event is open to PG students.Participants should carry laptops, net setters, pen drives etc. for their use. The organisers shall not be responsible for providing any of these items. Any team found using unfair means shall be immediately disqualified.To keep your identity confidential, participants are supposed to use the team name allotted by the Echelon team.  </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solidM4").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">TECH NOVANZA</p><p>[MBA]</p><p id="date">Date: Day 1 & 2</p><p id="fee">Entry Fee: Rs 200/-</p><p id="location">Location: 401(New Building)</p><p id="time">Timing: 11:00 AM -- 5:00 PM<br/>Day-2 : 9:00 AM-- 4:00 PM</p><p>Student Coordinator:<br>Ms. AISWARYA C P (+91 9562861928)</p><p id="rules">Rules: <br />Three make a team.The event is open to PG students. Participants should carry laptops, net setters, pen drives etc. for their use. The organisers shall not be responsible for providing any of these items.Judges’ and the organisers’ decision will be final and binding.Any team found using unfair means shall be immediately disqualified.To keep your identity confidential, participants are supposed to use the team name allotted by the Echelon team.  </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solidM5").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">TECH MAVEN</p><p>[MBA]</p><p id="date">Date: Day 1 & 2</p><p id="fee">Entry Fee: Rs 200/-</p><p id="location">Location:103(New Building) </p><p id="time">Timing: 11:00 AM -- 5:00 PM <br/>Day-2 : 9:00 AM-- 4:00 PM</p><p>Student Coordinator:<br>Mr. RANJAN SHETTY (+91 8749024731)</p><p id="rules">Rules: <br />One Participant.Any number of teams can participate in the event.The event is open to PG students. Participants should carry laptops, net setters, pen drives etc. for their use. The organisers shall not be responsible for providing any of these items.Judges’ and the organisers’ decision will be final and binding.Any team found using unfair means shall be immediately disqualified.To keep your identity confidential, participants are supposed to use the team name allotted by the Echelon team.  </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solidM6").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">TECH WHIZ</p><p>[MBA]</p><p id="date">Date: Day 1 & 2</p><p id="fee">Entry Fee: Rs 200/-</p><p id="location">Location:101(New Building) </p><p id="time">Timing: 11:00 AM -- 5:00 PM<br/>Day-2 : 9:00 AM-- 4:00 PM</p><p>Student Coordinator:<br>Mr. SUSHANTH A K (+91 7994135321)</p><p id="rules">Rules: <br />Two make a team.The event is open to PG students. Participants should carry laptops, net setters, pen drives etc. for their use. The organisers shall not be responsible for providing any of these items.Judges’ and the organisers’ decision will be final and binding.Any team found using unfair means shall be immediately disqualified.To keep your identity confidential, participants are supposed to use the team name allotted by the Echelon team.       </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solidM7").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">SPARK TANK</p><p>[MBA]</p><p id="date">Date: Day 1 & 2 </p><p id="fee">Entry Fee: Rs 200/-</p><p id="location">Location: Seminar Hall(New Building)</p><p id="time">Timing: 11:00 AM -- 5:00 PM<br/>Day-2 : 9:00 AM-- 4:00 PM</p><p>Student Coordinator:<br>Mr. NIKHIL K S (+91 7306670255)</p><p id="rules">Rules: <br />Three make a team.   Each round will be time-bound.   Participants should be ready to pitch their business idea for the first round. Any number of teams from a college can participate in the event. Participants should carry laptops, net setters, pen drives etc for their use. The organisers shall not be responsible for providing any of the necessary items.Judges’ and the organisers’ decision will be final and binding. Any team found using unfair means shall be immediately disqualified.To keep your identity confidential, participants are supposed to use the team’s name. </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
