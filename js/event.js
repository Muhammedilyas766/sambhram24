...
$(".button-solidM2").click(function() {
    Swal.fire({
        title: "Event Details",

        html: '<div class="modalEventDetails"><p id="eventName">TECH HUMANOS</p><p>[MBA]</p><p id="date">Date: Day 1</p><p id="fee">Entry Fee: Rs 200/-</p><p id="location">Location:404(New Building) </p><p id="time">Timing: 11:00 AM -- 5:00 PM</p><p>Student Coordinator:<br> Mr. SHABNAM KHATUN (+91 7483105970)</p><p id="rules">Rules: <br />Any number of participants can participate in the event.The event is open to PG students.The registration fee is ₹200/head.Participants should carry laptops, net setters, pen drives etc. for their use. The organisers shall not be responsible for providing any of these items.Judges’ and the organisers’ decision will be final and binding.Any team found using means shall be immediately disqualified.To keep your identity confidential, participants are to use the team name allotted by the Echelon team.     </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solidM3").click(function() {
    Swal.fire({
        title: "Event Details",

        html: '<div class="modalEventDetails"><p id="eventName">TECH IGNITE </p><p>[MBA]</p><p id="date">Date: Day 1</p><p id="fee">Entry Fee: Rs 200/-</p><p id="location">Location: 104(New Building)</p><p id="time">Timing: 11:00 AM -- 5:00 PM</p><p>Student Coordinator:<br>Ms. AFRAZ FATHIMA (+91 8050101620)</p><p id="rules">Rules: <br />Two members in a team.The event is open to PG students.Participants should carry laptops, net setters, pen drives etc. for their use. The organisers shall not be responsible for providing any of these items.The registration fee is ₹200/head.Any team found using means shall be immediately disqualified.To keep your identity confidential, participants are to use the team name allotted by the Echelon team.  </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solidM4").click(function() {
    Swal.fire({
        title: "Event Details",

        html: '<div class="modalEventDetails"><p id="eventName">TECH NOVANZA</p><p>[MBA]</p><p id="date">Date: Day 1</p><p id="fee">Entry Fee: Rs 200/-</p><p id="location">Location: 401(New Building)</p><p id="time">Timing: 11:00 AM -- 5:00 PM</p><p>Student Coordinator:<br>Ms. AISWARYA C P (+91 9562861928)</p><p id="rules">Rules: <br />Three members in a team.The event is open to PG students.The registration fee is ₹200/head.Participants should carry laptops, net setters, pen drives etc. for their use. The organisers shall not be responsible for providing any of these items.Judges’ and the organisers’ decision will be final and binding.Any team found using means shall be immediately disqualified.To keep your identity confidential, participants are to use the team name allotted by the Echelon team.  </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solidM5").click(function() {
    Swal.fire({
        title: "Event Details",

        html: '<div class="modalEventDetails"><p id="eventName">TECH MAVEN</p><p>[MBA]</p><p id="date">Date: Day 1</p><p id="fee">Entry Fee: Rs 200/-</p><p id="location">Location:102(New Building) </p><p id="time">Timing: 11:00 AM -- 5:00 PM</p><p>Student Coordinator:<br>Mr. RANJAN SHETTY (+91 8749024731)</p><p id="rules">Rules: <br />One Participant.Any number of participants can participate in the event.The event is open to PG students. The registration fee is ₹200/head.Participants should carry laptops, net setters, pen drives etc. for their use. The organisers shall not be responsible for providing any of these items.Judges’ and the organisers’ decision will be final and binding.Any team found using means shall be immediately disqualified.To keep your identity confidential, participants are to use the team name allotted by the Echelon team.  </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solidM6").click(function() {
    Swal.fire({
        title: "Event Details",

        html: '<div class="modalEventDetails"><p id="eventName">TECH WHIZ</p><p>[MBA]</p><p id="date">Date: Day 1</p><p id="fee">Entry Fee: Rs 200/-</p><p id="location">Location:101(New Building) </p><p id="time">Timing: 11:00 AM -- 5:00 PM</p><p>Student Coordinator:<br>Mr. SUSHANTH A K (+91 7994135321)</p><p id="rules">Rules: <br />Two make a team.The event is open to PG students.The registration fee is ₹200/head.Participants should carry laptops, net setters, pen drives etc. for their use. The organisers shall not be responsible for providing any of these items.Judges’ and the organisers’ decision will be final and binding.Any team found using means shall be immediately disqualified.To keep your identity confidential, participants are to use the team name allotted by the Echelon team.       </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solid22").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">SAMBHRAM SOIRÉE</p><p>[SOLO SINGING]</p><p id="date">Date: Day 2</p><p id="fee">Entry Fee: Rs 250/-</p><p id="location">Location: EDUSAT Room</p><p id="time">Timing: 9:30 AM -- 11:30 AM</p><p>Student Coordinator:<br>Ms. DEEPALI (+91 8217354024)</p><p id="rules">Rules: <br />Singers can be accompanied by a maximum 1 instrument player. Singers can sing with or without Karaoke. Time limit is 3+1 min. Judges decision will be final. Choice of the song is open to the participants.</p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solid24").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">LABYRINTH</p><p>[TREASURE HUNT]</p><p id="date">Date: Day 2</p><p id="fee">Entry Fee: Rs 250/-</p><p id="location">Location: 102(New Building) </p><p id="time">Timing: 10:00 AM </p><p>Student Coordinator:<br>Mr. ABDUL MANAN (+91 8792839142)</p><p id="rules">Rules: <br /> Round 1-MCQ Round ( Riddle type questions). Round 2 -Scavenger hunt (Team should collect the items that is in the list).Round 3 -The Final Round - the clues are to be found in a particular order.     </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solid25").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">LUDO</p><p></p><p id="date">Date: Day 2</p><p id="fee">Entry Fee: Rs 150/-</p><p id="location">Location: 302 (Canteen Building)</p><p id="time">Timing: 10:00 AM</p><p>Student Coordinator:<br>Mr. SURESH PATIL (+91 8095246719)</p><p id="rules">Rules: <br />Players should pre-install the Ludo King app in their mobile.No team-up. Any foul play will result in immediate disqualification. Any number of participants can join from the same college.</p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solid31").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">NACHYUDH </p><p>[FACE OFF DANCE]</p><p id="date">Date: Day 2</p><p id="fee">Entry Fee: Rs 250/-</p><p id="location">Location: GALLERY, NEAR PHYSICS LAB</p><p id="time">Timing: 1:30 PM -- 2:30 AM</p><p>Student Coordinator:<br>Ms. DEEKSHA (YEAR IV - CS) [+91 7019576245]</p><p id="rules">Rules: <br /> Dancers will be challenged to dance to the unpredictable, varied beats of a live DJ.The music genre will change for each pair of dancers and can range from any genre of music such as rap, pop, breakbeats, funk, electronica, house music, etc.Judges will choose 1 dancer from each battle to advance to the next round until the battle progresses to 2 final dancers. Each dancer will be judged on his/her Artistic Creativity, his/her Musicality, and his/her ability to entertain the judges.</p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solid32").click(function() {
    Swal.fire({
        title: "Event Details",

        html: '<div class="modalEventDetails"><p id="eventName">MEME MIRTH </p><p>[MEME MAKER]</p><p id="date">Date: Day 2</p><p id="fee">Entry Fee: Rs 250/-</p><p id="location">Location: ROOM NO 101</p><p id="time">Timing: 9:30 AM -- 10:30 AM</p><p>Student Coordinator:<br>Mr. AMAN NIVEDH [+91 9980618704]</p><p id="rules">Rules: <br />Two make a team. Participants can use any application or website to create memes. Topics will be given on spot.Participants are permitted to use mobile or laptops for the same. </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solid37").click(function() {
    Swal.fire({
        title: "Event Details",

        html: '<div class="modalEventDetails"><p id="eventName">MAD ADS</p><p></p><p id="date">Date: Day 2</p><p id="fee">Entry Fee: Rs 250/-</p><p id="location">Location:AUDITORIUM.</p><p id="time">Timing: 10:00 AM -- 11:00 AM</p><p>Student Coordinator:<br>Ms. DEEPTHI (+91 9591699197)</p><p id="rules">Rules: <br />  Props are not allowed. Vulgarity will not be entertained </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solidS1").click(function() {
    Swal.fire({
        title: "Event Details",

        html: '<div class="modalEventDetails"><p id="eventName">CYBER SCORE KICK</p><p>[E-FOOTBALL]</p><p id="date">Date: Day 1</p><p id="fee">Entry Fee: Rs 100/- Per Person</p><p id="location">Location:1st Floor VLSI Lab </p><p id="time">Timing: 10:00 AM </p><p>Student Coordinator:<br>Mr. ISHAN (+91 9353205876)</p><p id="rules">Rules: <br />Tournament will be in knockout mode.Only one game will be played against an opponent in a round (There will be no home and away matches).Players can decide who will create the match room.Participants must schedule the matches with their opponents only within the specified timeline.If any player is not ready for the match before the deadline, then the opposition will be deemed victorious.If both players fail to play their matches by the deadline, the match will be deemed null and void and none of them can qualify for next round.If a player leaves the game midway, then he will be disqualified. After every match, the player who won should send a screenshot to the group with the caption “won vs @mention (opposite player).             </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solidS3").click(function() {
    Swal.fire({
        title: "Event Details",

        html: '<div class="modalEventDetails"><p id="eventName">GULLY CRICKET</p><p></p><p id="date">Date: Day 1</p><p id="fee">Entry Fee: Rs 100/- per person</p><p id="location">Location: BEHIND PHARMACY BUILDING</p><p id="time">Timing: 10:00 AM</p><p>Student Coordinator:<br>Msr. VINOD REDDY(7483629493)</p><p id="rules">Rules: <br />Limited overs.Umpire decision is final and binding.Entry fees 100/head.</p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solidS4").click(function() {
    Swal.fire({
        title: "Event Details",

        html: '<div class="modalEventDetails"><p id="eventName">BGMI</p><p></p><p id="date">Date: Day 2</p><p id="fee">Entry Fee: Rs 100/- Per Person</p><p id="location">Location:1st Floor ISE Lab </p><p id="time">Timing: 9:30 AM </p><p>Student Coordinator:<br>Mr. JEEVAN [7019264954]</p><p id="rules">Rules: <br />Players must download Erangel and Miramer maps.If any participant is found using hacks, the whole team will be subject to disqualification.Point system will be the same as official BGMI tournaments.Players using iPad not allowed and No switching teams.</p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solidC8").click(function() {
    Swal.fire({
        title: "Event Details",

        html: '<div class="modalEventDetails"><p id="eventName">SHUTTER SAGA</p><p>[MCA]</p><p id="date">Date: Day 1</p><p id="fee">Entry Fee: Rs 100/- Per Person</p><p id="location">Location: PG Block Class (201)</p><p id="time">Timing: 11:00 AM -- 3:00 AM</p><p>Student Coordinator:<br>Mr. Akash (+916362160700)</p><p id="rules">Rules: <br />Round details will be given on the spot. Participants should get their own gadgets.  </p><a class="reglink" href="http://register.shreedevisambhram.com">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
